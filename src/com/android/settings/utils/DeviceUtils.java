...
public class DeviceUtils {
    ...
    /* returns whether the device has any physical button navigation or not. */
    public static boolean hasPhysicalNavKeys(Context context) {
        return (hasBackKey(context) || hasHomeKey(context) || 
                hasMenuKey(context) || hasAssistKey(context) ||
    ...
    public static boolean isKeySwapperSupported(Context context) {
        final LineageHardwareManager hardware = LineageHardwareManager.getInstance(context);
